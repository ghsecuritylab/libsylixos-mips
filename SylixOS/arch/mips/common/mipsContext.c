...
VOID  archTaskCtxShow (INT  iFd, PLW_STACK  pstkTop)
{
    ...
    fdprintf(iFd, "SR Bit CU3  = %4d\n", (uiCP0Status & M_StatusCU3) >> S_StatusCU3);
    fdprintf(iFd, "SR Bit CU2  = %4d\n", (uiCP0Status & M_StatusCU2) >> S_StatusCU2);
    fdprintf(iFd, "SR Bit CU1  = %4d\n", (uiCP0Status & M_StatusCU1) >> S_StatusCU1);
    fdprintf(iFd, "SR Bit CU0  = %4d\n", (uiCP0Status & M_StatusCU0) >> S_StatusCU0);
    fdprintf(iFd, "SR Bit RP   = %4d\n", (uiCP0Status & M_StatusRP)  >> S_StatusRP);
    fdprintf(iFd, "SR Bit FR   = %4d\n", (uiCP0Status & M_StatusFR)  >> S_StatusFR);
    fdprintf(iFd, "SR Bit RE   = %4d\n", (uiCP0Status & M_StatusRE)  >> S_StatusRE);
    fdprintf(iFd, "SR Bit MX   = %4d\n", (uiCP0Status & M_StatusMX)  >> S_StatusMX);
    fdprintf(iFd, "SR Bit PX   = %4d\n", (uiCP0Status & M_StatusPX)  >> S_StatusPX);
    fdprintf(iFd, "SR Bit BEV  = %4d\n", (uiCP0Status & M_StatusBEV) >> S_StatusBEV);
    fdprintf(iFd, "SR Bit TS   = %4d\n", (uiCP0Status & M_StatusTS)  >> S_StatusTS);
    fdprintf(iFd, "SR Bit SR   = %4d\n", (uiCP0Status & M_StatusSR)  >> S_StatusSR);
    fdprintf(iFd, "SR Bit NMI  = %4d\n", (uiCP0Status & M_StatusNMI) >> S_StatusNMI);
    fdprintf(iFd, "SR Bit IM7  = %4d\n", (uiCP0Status & M_StatusIM7) >> S_StatusIM7);
    fdprintf(iFd, "SR Bit IM6  = %4d\n", (uiCP0Status & M_StatusIM6) >> S_StatusIM6);
    fdprintf(iFd, "SR Bit IM5  = %4d\n", (uiCP0Status & M_StatusIM5) >> S_StatusIM5);
    fdprintf(iFd, "SR Bit IM4  = %4d\n", (uiCP0Status & M_StatusIM4) >> S_StatusIM4);
    fdprintf(iFd, "SR Bit IM3  = %4d\n", (uiCP0Status & M_StatusIM3) >> S_StatusIM3);
    fdprintf(iFd, "SR Bit IM2  = %4d\n", (uiCP0Status & M_StatusIM2) >> S_StatusIM2);
    fdprintf(iFd, "SR Bit IM1  = %4d\n", (uiCP0Status & M_StatusIM1) >> S_StatusIM1);
    fdprintf(iFd, "SR Bit IM0  = %4d\n", (uiCP0Status & M_StatusIM0) >> S_StatusIM0);
    fdprintf(iFd, "SR Bit KX   = %4d\n", (uiCP0Status & M_StatusKX)  >> S_StatusKX);
    fdprintf(iFd, "SR Bit SX   = %4d\n", (uiCP0Status & M_StatusSX)  >> S_StatusSX);
    fdprintf(iFd, "SR Bit UX   = %4d\n", (uiCP0Status & M_StatusUX)  >> S_StatusUX);
    fdprintf(iFd, "SR Bit KSU  = %4d\n", (uiCP0Status & M_StatusKSU) >> S_StatusKSU);
    fdprintf(iFd, "SR Bit UM   = %4d\n", (uiCP0Status & M_StatusUM)  >> S_StatusUM);
    fdprintf(iFd, "SR Bit SM   = %4d\n", (uiCP0Status & M_StatusSM)  >> S_StatusSM);
    fdprintf(iFd, "SR Bit ERL  = %4d\n", (uiCP0Status & M_StatusERL) >> S_StatusERL);
    fdprintf(iFd, "SR Bit EXL  = %4d\n", (uiCP0Status & M_StatusEXL) >> S_StatusEXL);
